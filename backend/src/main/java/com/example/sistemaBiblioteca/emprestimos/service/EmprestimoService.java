...
import com.example.sistemaBiblioteca.emprestimos.controller.EmprestimoController;
...
*/  
    ...
    public <T> void verificarIgualdade(T valorEntidade, T valorComparacao, String messagem, Long emprestimoId) {
        if (!valorEntidade.equals(valorComparacao)) {
            LOGGER.warn("Dados de empréstimo inválidos para devolução. {} ID: {}, Empréstimo ID: {}", messagem, valorComparacao, emprestimoId);
